  ...
  const reviews = [
    {
      name: "Bala koti",
      role: "Homeowner",
      text: "The best part about working with Claur Studio was the attention to detail. From laminates to lighting suggestions, everything was thoughtfully planned. The final outcome looked premium.",
      rating: 5,
      projectId: "project-1"
    },
    {
      name: "Subhash",
      role: "3BHK Owner",
      text: "Claur Studio completely transformed our 3BHK into a modern and functional space. The designs were elegant, practical, and exactly what we wanted. Execution was smooth and the team was very responsive throughout the project.",
      rating: 5,
      projectId: "project-2"
    },
    {
      name: "Srinivas",
      role: "Homeowner",
      text: "Minimal, classy, and practical designs. Claur Studio gave our home a completely fresh feel while keeping everything functional for daily use.",
      rating: 5,
      projectId: "project-3"
    },
    {
      name: "Surya",
      role: "Homeowner",
      text: "Very happy with the 3D designs and space planning. Every corner was utilized beautifully without making the house feel crowded. Highly recommend Claur Studio for contemporary interiors.",
      rating: 5,
      projectId: "project-4"
    },
    {
      name: "Raghu",
      role: "Homeowner",
      text: "Professional service and excellent communication. The 3D visualization helped us clearly understand the final look before execution started. Overall a very good experience.",
      rating: 5,
      projectId: "project-5"
    }
  ]
